...
public class ServerThread implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.out.println(String.format("[服务器]已接收到请求：%s，目前%d个客户端正在连接。", cmd, m_server.ClientCount));
            ...
            System.out.println(String.format("[服务器]请求处理完毕，关闭Socket连接。剩余：%d个客户端连接", m_server.ClientCount));
        }
    }
